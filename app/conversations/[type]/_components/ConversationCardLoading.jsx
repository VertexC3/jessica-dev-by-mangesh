export default function ConversationCardLoading() {
    return (
        <div className="mb-2 w-full min-w-[280px] animate-pulse cursor-pointer rounded-lg border border-transparent px-2 py-3 hover:border-blue-600 hover:bg-blue-50">
